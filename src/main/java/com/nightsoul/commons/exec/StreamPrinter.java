 ...
 ******************************************************************************/
package com.nightsoul.commons.exec;
...
public class StreamPrinter extends Thread implements StreamHandler {
	...
	public void run() {
		...
		try {
			...
			String line = null;
			if(ObjectUtils.isNotNull(prefix)){
				while (!terminated && ObjectUtils.isNotNull((line = bufferedReader.readLine()))) {
